#!/usr/bin/env python3
'''
	This is a utility module for Boston-compass.
...
class ReturnCodes:
	...
	MESSAGES = {
		...
		FEATURE_NOT_IMPLEMENTED: "This feature is not implemented for this version of BC.",
...
class BCUtility:
	"""
	This class provides general and common methods for all BC classes or scripts.
	"""
	@staticmethod
